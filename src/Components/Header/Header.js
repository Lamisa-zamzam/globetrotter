...
const Header = () => {
    ...
    return (
        <Navbar expand="lg" bg="light">
            <Navbar.Brand as={Link} to="/home"><img src="https://image.shutterstock.com/image-vector/initial-letter-gt-modern-linked-260nw-444629587.jpg" alt="" className="logo"/><h4 style={{display: "inline"}}> <span className="brand-name"> Globetrotter</span></h4><h4><i className="brand-type"> the city ride service</i></h4>
